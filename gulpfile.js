...
function styles() {
	return src([`src/styles-src/${preprocessor}/*.*`, `!src/styles-src/${preprocessor}/_*.*`])
...
async function buildhtml() {
	let includes = new ssi('src/html', 'dist/html', '/**/*.html')
	includes.compile()
	del('dist/html/parts', { force: true })
}
...
function startwatch() {
	watch(`src/styles-src/${preprocessor}/**/*`, { usePolling: true }, styles)
